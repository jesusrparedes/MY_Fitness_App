document.addEventListener('DOMContentLoaded', async () => {
    ...
    const exerciseDB = {
        chest: {
            john_wooden: [
                { name: "Machine Chest Press", volume: "3x8-10", primary: "Pectoralis Major (Mid)", secondary: "Triceps, Anterior Deltoids", targets: ["mid_chest"] }, 
                ...
                { name: "Incline Machine Press", volume: "3x8-10", primary: "Pectoralis Major (Upper)", secondary: "Triceps, Anterior Deltoids", targets: ["upper_chest"] }
            ],
            home: [
        ...
        back: {
            john_wooden: [
                { name: "Lat Pulldown", volume: "3x8-10", primary: "Latissimus Dorsi", secondary: "Biceps, Rear Deltoids", targets: ["lats"] }, 
                { name: "Seated Cable Row", volume: "3x10-12", primary: "Rhomboids, Mid-Traps", secondary: "Lats, Biceps", targets: ["mid_back", "lats"] }, 
                { name: "T-Bar Row", volume: "4x8-10", primary: "Lats, Mid-Back", secondary: "Biceps, Lower Traps", targets: ["lats", "mid_back", "traps"] }, 
        ...
        legs: {
            john_wooden: [
                ...
                { name: "Leg Extension Machine", volume: "3x12-15", primary: "Quadriceps", secondary: "None", targets: ["quads"] }, 
                { name: "Seated Leg Curl", volume: "3x12-15", primary: "Hamstrings", secondary: "Calves", targets: ["hamstrings"] }, 
                { name: "Calf Raise Machine", volume: "4x15-20", primary: "Gastrocnemius, Soleus", secondary: "None", targets: ["calves"] }
            ],
            home: [
        ...
        arms: {
            john_wooden: [
                { name: "Cable Tricep Pushdown", volume: "3x10-12", primary: "Triceps Brachii", secondary: "None", targets: ["triceps"] }, 
                { name: "Preacher Curl Machine", volume: "3x10-12", primary: "Biceps Brachii", secondary: "Brachialis", targets: ["biceps"] }, 
                { name: "Hammer Curls", volume: "3x10-12", primary: "Brachioradialis", secondary: "Biceps", targets: ["biceps", "forearms"] }, 
                { name: "Wrist Curls", volume: "3x15", primary: "Forearm Flexors", secondary: "None", targets: ["forearms"] }
            ],
            home: [
        ...
        cardio: {
            john_wooden: [
                ...
                { name: "Stationary Bike", volume: "1x30 mins", primary: "Cardiovascular System", secondary: "Legs", targets: ["steady_state", "intervals"] }
            ],
            home: [
